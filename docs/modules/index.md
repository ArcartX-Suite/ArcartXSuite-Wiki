...
| EntityTracker | 福利 | ArcartX | MythicMobs/MythicBukkit、PlaceholderAPI、NeigeItems、MythicLib/MMOItems、Redis、Vault | Boss 追踪需要 Mythic；普通攻击目标 HUD 可独立使用；Redis 用于跨服排行；Vault 用于金钱奖励 |
