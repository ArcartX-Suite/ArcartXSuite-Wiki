...
AXS 共 **23 个功能模块**，涵盖聊天、战斗、播报、追踪、登录、基础工具、区域保护、通用菜单、经济交易、QQ群联动等核心玩法。其中 **13 个免费模块** 开箱即用，**8 个付费模块 与 2 个福利模块** 需要单独授权。
...
<div class="module-grid">
  ...
  <a href="afkreward" class="module-card">
    <div class="card-icon">♨️</div>
    <div class="card-title">AfkReward 区域挂机奖励</div>
    <div class="card-desc">多边形区域挂机、周期命令奖励、VIP 权限阶梯、人数/次数上限控制、PAPI 输出、HUD 面板</div>
    <span class="card-badge badge-stable">✅ 免费</span>
  </a>
</div>
