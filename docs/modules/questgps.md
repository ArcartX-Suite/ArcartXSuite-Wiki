...
navigation:
  ...
  quest-id-prefix: "ArcartX-Suite-questgps-"      # 路径点 ID 前缀
...
| 功能 | UI ID | 说明 |
| --- | --- | --- |
| 任务菜单 | `ArcartX-Suite:questgps_menu` | 分类任务列表、描述、奖励预览、接取/放弃/追踪 |
| 任务指引 HUD | `ArcartX-Suite:questgps_guide` | 追踪中显示的任务目标清单和导航坐标 |
