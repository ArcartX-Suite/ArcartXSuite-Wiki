...
const __pageData = JSON.parse('{"title":"变更日志","description":"","frontmatter":{},"headers":[],"relativePath":"appendix/changelog.md","filePath":"appendix/changelog.md","lastUpdated":1780071479000}');
const _sfc_main = { name: "appendix/changelog.md" };
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", null, [..._cache[0] || (_cache[0] = [
    createStaticVNode("", 68)
  ])]);
}
