...
export default withMermaid(defineConfig({
  ...
  title: 'ArcartX-Suite',
  description: 'ArcartX-Suite 是面向 ArcartX 客户端的 28 模块 Minecraft 服务器插件套件，涵盖全球市场、抽奖开箱、钓鱼、称号、战令、仓库等核心玩法，自带 ArcartX UI 界面，我的世界服务器开发者的首选插件。',
  ...
  head: [
    ...
    ['meta', { name: 'description', content: 'ArcartX-Suite 是面向 ArcartX 客户端框架的 28 模块 Minecraft 服务器插件套件，涵盖聊天、战斗、播报、经济交易、全球市场、抽奖、钓鱼等核心玩法，自带 ArcartX UI 界面。' }],
    ...
    ['meta', { property: 'og:title', content: 'ArcartX-Suite - 28个Minecraft服务器模块插件套件' }],
    ['meta', { property: 'og:description', content: 'ArcartX-Suite 提供 28 个功能模块，涵盖经济交易、全球市场、抽奖开箱、钓鱼、称号、战令等核心玩法，自带 ArcartX UI 界面。' }],
